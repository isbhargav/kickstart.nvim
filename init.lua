...
require('lazy').setup({
  ...
  -- netrw upgrade
  { 'prichrd/netrw.nvim', dependencies = { 'tpope/vim-vinegar', "nvim-tree/nvim-web-devicons" },          config = true },
  -- persistance undo
  ...
  -- harpoon files
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<c-p>', require("harpoon.mark").add_file)
    end
  },
  ...
  { 'folke/which-key.nvim',  opts = {},          enabled = false },
  {
